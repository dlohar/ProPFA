...
const char *argp_program_version = "yara 2.0";
const char *argp_program_bug_address = "<dibyendu.das.in@gmail.com>";

/* Program documentation. */
static char doc[] = "yara -- Yet Another Range Analyzer,\n\
that performs static value and interval analysis of any ‘C-like’ programs.\
...
Examples:\n\
  yara -ca input collatz x=10\t\t\tAnalyze collatz function from file input, in both abstract and concrete domains, with its only parameter set to value 10.\n\
  yara -aw input collatz x=[-10,40]\t\tAnalyze collatz function from file input, in abstract domain using widening, with its only parameter set to range [-10,40].\n\
  yara -a input euclid_gcd b=-20 a=[-10,10]\tAnalyze euclid_gcd function from file input, in abstract domain, with parameters a set to range [-10,10] and b set to -20.\n\
  yara -ac input euclid_gcd a=35 b=7\t\tAnalyze euclid_gcd function from file input, in both abstract and concrete domains, with parameters a set to 35 and b set to 7.";
